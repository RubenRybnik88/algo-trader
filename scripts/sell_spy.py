...
SYMBOL = "AAPL"  # same as buy script

# Parse CLI arguments
parser = argparse.ArgumentParser(description="Place a paper sell order for AAPL")
...
sell_order.outsideRTH = True  # enable outside regular trading hours

# Place order
trade = ib.placeOrder(contract, sell_order)
print("Sell order submitted, waiting for fill...")
...
if trade.orderStatus.status == 'Filled':
    print(f"✅ Sell order filled: {trade.orderStatus.filled} @ {trade.orderStatus.avgFillPrice}")
else:
